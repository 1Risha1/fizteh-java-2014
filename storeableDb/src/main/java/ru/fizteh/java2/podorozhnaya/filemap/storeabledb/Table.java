...
public interface Table extends AutoCloseable {
     ...
     * @throws ru.fizteh.fivt.storage.structured.ColumnFormatException - при попытке передать ru.fizteh.java2.podorozhnaya.database.filemap.Storeable с колонками другого типа.
     */
